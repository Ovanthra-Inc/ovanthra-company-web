    ...
    return (
        <section className="py-20 lg:py-32">
            <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
                <div className="bg-brand-navy rounded-2xl lg:rounded-[2rem] p-8 sm:p-16 lg:p-24 text-center text-white relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-8 lg:gap-10">
                        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-medium tracking-tight serif leading-tight">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 lg:gap-5 w-full sm:w-auto">
                            <button className="w-full sm:w-auto bg-white text-brand-navy px-10 lg:px-12 py-4 lg:py-5 rounded-lg font-bold hover:bg-slate-100 transition-all shadow-lg cursor-pointer text-sm lg:text-base">
